enum SK {
    ...
    static let image_layer_preview_key = "pref_show_layers_preview"
    static let image_layer_standby_key = "pref_stream_stanby_mode"
    static let image_layer_standby_images_key = "pref_stream_stanby_images"
    static let image_layer_pause_images_key = "pref_stream_pause_images"
    
    //static let overlaysContainerName = "group.com.softvelum.ImageEditor"
