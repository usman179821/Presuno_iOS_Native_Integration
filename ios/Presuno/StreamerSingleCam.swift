...
class StreamerSingleCam: Streamer {
    ...
    override func processVideoSampleBuffer(_ sampleBuffer: CMSampleBuffer, fromOutput videoDataOutput: AVCaptureVideoDataOutput) {
        ...
        } else if !imageLayer.activeLayers.isEmpty {
    ...
    func createOutputBuffer() -> CVPixelBuffer? {
    ...
    func combineWithOverlay(sourceImage: CIImage) -> CIImage {
        ...
        if let layerImage = imageLayer.outputImage {
            let combinedFilter = CIFilter(name: "CISourceOverCompositing")!
            combinedFilter.setValue(layerImage, forKey: "inputImage")
            combinedFilter.setValue(sourceImage, forKey: "inputBackgroundImage")
